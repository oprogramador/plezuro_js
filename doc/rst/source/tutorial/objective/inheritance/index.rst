...
the module. The algorithm of find a method is recursive. When no method is
found, an exception is thrown. It is as you can see it. However in reality in
the moment of a module creation all the methods are binded (direct ones and
...
inheritance. You can create a module with a specific method and use objects of this module in
