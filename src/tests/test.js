...
a = '../../bin/js/26.plez.js'.import(2,9,87,7,6,777);
assert.strictEqual(JSON.stringify(a), '[["../../bin/js/26.plez.js",2,9,87,7,6,777],20,87.22222222222223]');

a = '../../bin/js/primes.plez.js'.import(100);
assert.strictEqual(a, 541);

a = '../../bin/js/27.plez.js'.import(2,9,87,7,6,777);
assert.strictEqual(JSON.stringify(a), '["wfwfwfe is not defined","blabla"]');

a = '../../bin/js/28.plez.js'.import(9);
assert.strictEqual(JSON.stringify(a), '[189,"B"]');

a = '../../bin/js/28.plez.js'.import(40);
assert.strictEqual(JSON.stringify(a), '[22,"A"]');

a = '../../bin/js/28.plez.js'.import(15);
assert.strictEqual(JSON.stringify(a), '[7,"D"]');

a = '../../bin/js/28.plez.js'.import(17);
assert.strictEqual(JSON.stringify(a), '[336,"C"]');

a = '../../bin/js/29.plez.js'.import();
assert.strictEqual(a, 112);

a = '../../bin/js/30.plez.js'.import();
assert.strictEqual(a, 24);

a = '../../bin/js/obj1.plez.js'.import();
assert.strictEqual(a, 181);

a = '../../bin/js/obj2.plez.js'.import();
assert.strictEqual(JSON.stringify(a), '[181,"person a=90","student a=90","student a=90"]');

a = '../../bin/js/obj2.plez.js'.import();
assert.strictEqual(JSON.stringify(a), '[181,"person a=90","student a=90","student a=90"]');

a = '../../bin/js/obj3.plez.js'.import();
